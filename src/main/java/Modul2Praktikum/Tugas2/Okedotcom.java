 ...
 */
package Modul2Praktikum.Tugas2;
...
class Okedotcom {
    ...
    public Okedotcom(int rows, int cols) {
        this.totalRows = rows;
        this.totalCols = cols;
    ...
    public static void main(String[] args) {
        ...
        Okedotcom ticketSystem = new Okedotcom(rows, cols);
        ...
        do {
            ...
            switch (choice) {
                ...
                case '2':
                    ...
                    break;
                case '3':
                    System.out.println("Available Seats Count: " + ticketSystem.seatsAvailable);
                    break;
                case '4':
